...
# main_fig <- ggsave("figures/spp_study3.png", width = 5, height = 5, plot = main_fig, bg = "transparent")
main_fig <- ggsave("figures/spp_study3_white.png", width = 7, height = 5, plot = main_fig, bg = "white")
