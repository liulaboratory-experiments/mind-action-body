...
data_path <- paste0(base_path, "/data/data-study1/study1_data_raw.csv")
...
#paths: data outputs
rdm_figures_outputs_path <- paste0(base_path, "/analysis/study1-measure/figures/theoretical-rdms/")
combined_output_csv <- "data_processed_step1"
snapshots_path <- paste0(base_path, "/analysis/study1-measure/snapshots_study1_preprocessing_analysis")
...
#write.csv(data_freesort, file = freesort_output_path, row.names = F) #doesn't work
```
...
```{r}
#load USE embeddings
embedding_df <- readRDS(here(base_path, "analysis", "study1-measure", "embeddings", "item_embeddings.rds")) 
