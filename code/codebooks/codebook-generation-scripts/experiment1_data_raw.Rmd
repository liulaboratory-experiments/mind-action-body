...
```{r, echo = FALSE}
base_path <- here("code", "data", "1_measure")
data_path <- paste0(base_path, "/data_raw.csv")
...
var_label(d) <- list(
        ...
        response = "For the Causal Pairs Task, a dictionary containing subject responses for all 14 questions in each page",
