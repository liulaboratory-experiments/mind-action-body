...
fig_slope <- dat_condition_summarized %>%
  ...
  geom_errorbar(data = filter(dat_condition_summarized, response == "Direct"), 
              aes(ymax = ci_high,
                  ymin = ci_low,
                  width = 0.3)) +
  #   geom_text(
  #   data = dplyr::filter(dat_trial_summarized, response == "Direct"),
  #   aes(label = joined),
  #   size = 2,
  #   vjust = -0.5
  # ) +
...
# fig_slope <- ggsave("figures/prediction_slope.png", width = 3, height = 6, plot = fig_slope, bg = "white")
