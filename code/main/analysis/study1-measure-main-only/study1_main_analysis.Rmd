...
# paths
## script inputs
base_path <- here("code", "main", "analysis", "study1-measure-main-only")
...
data_processed_output_path <- paste0(snapshots_output_path, "/main_data_processed_step2.csv") #not used in a subsequent script
